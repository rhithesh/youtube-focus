...
export const DEMO_TILES: (Thumb & { bait: number; goal: number; junk: number; conf: number })[] = [
  {
    id: "d1",
    title: "You WON'T BELIEVE what happened next (GONE WRONG)",
    channel: "DramaDaily",
  ...
  {
    id: "d4",
    title: "I coded for 100 days straight (honest results)",
    channel: "BuildLog",
    meta: "410K views · 1 week ago",
    duration: "14:31",
    bg: "radial-gradient(circle at 40% 35%, #4a5240 0%, transparent 55%), radial-gradient(circle at 70% 70%, #2b3026 0%, transparent 50%), #14170f",
    glyph: "100",
    bait: 1.6,
    goal: 1.2,
    junk: 0.18,
  ...
  {
    id: "d5",
    title: "Neuroscientists REVEAL the #1 food nobody tells you",
    channel: "VitalHacks",
    meta: "890K views · 5 days ago",
    duration: "11:09",
    bg: "radial-gradient(circle at 35% 35%, #1f5f5a 0%, transparent 55%), radial-gradient(circle at 75% 70%, #123b38 0%, transparent 50%), #0a1514",
    glyph: "Ω",
    bait: 2.4,
    goal: 2.1,
    junk: 0.55,
